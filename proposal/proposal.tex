...
\begin{outline}[enumerate]
	...
	\1 {\rm[\ion{O}{2}]} Luminosity
		\2 Need to make HETDEX-like observations. Because HETDEX is designed to find \lya emitting galaxies, we are interested in [\ion{O}{2}] emitters at a lower redshift. The simulations do not include emission line information so we must assign it. 
	...
	\1 Mock Observations
		...
		\2 Sensitivity limits for HETDEX are 22 mag in SDSS \sdssg\ for galaxies $z<0.4$ and [\ion{O}{2}] line flux at least $3.5\times10^{-17}$ \ergscm\ for $0.4<z<0.5$ galaxies.
\end{outline}
