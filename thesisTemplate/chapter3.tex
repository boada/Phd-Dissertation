...
FROM Galaxy as G
JOIN dbo.fGetNearbyObjEq(16.2307083,0.06009167,3) as GN
	ON G.objID = GN.objID
LEFT JOIN Photoz as Pz ON G.objID = Pz.objID
LEFT JOIN SpecObj as SO ON G.objID = SO.bestObjID
Where 
	G.g < 22 AND clean = 1 and (calibStatus_r & 1) != 0
\end{lstlisting}
\end{singlespace}
