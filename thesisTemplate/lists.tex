...
%% Positions the LOF title vertically to match the chapter titles
...
\begin{singlespace}
	...
	\setlength{\cftbeforechapskip}{0.4cm} \setlength{\cftbeforesecskip}{0.30cm} \setlength{\cftbeforesubsecskip}{0.30cm} \setlength{\cftbeforefigskip}{0.4cm} \setlength{\cftbeforetabskip}{0.4cm} 
	...
	%% Positions the LOT title vertically to match the chapter titles
	...
	\begin{center}
		...
		\endgroup 
		\pagebreak{}
		% Need this for the pagenumbering to be correct. 
